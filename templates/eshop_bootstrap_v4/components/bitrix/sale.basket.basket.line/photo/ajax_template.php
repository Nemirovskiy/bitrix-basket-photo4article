					...
					<div class="bx-basket-item-list-item">
						<div class="bx-basket-item-list-item-img">
							<?if ($arParams["SHOW_IMAGE"] == "Y" && $v["PICTURE_SRC"]):?>
								...
								<?endif?>
							<?endif?>
							<?if ($arParams["SHOW_ARTICLE_IMAGE"] == "Y" && $v["ARTICLE_IMAGE_SRC"]):?>
								<?if($v["DETAIL_PAGE_URL"]):?>
                                    <a href="<?=$v["DETAIL_PAGE_URL"]?>"><img src="<?=$v["ARTICLE_IMAGE_SRC"]?>" alt="<?=$v["NAME"]?>"></a>
								<?else:?>
                                    <img src="<?=$v["ARTICLE_IMAGE_SRC"]?>" alt="<?=$v["NAME"]?>" />
								<?endif?>
							<?endif?>
